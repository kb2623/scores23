...
def mts_ls1(current_x, current_fitness, best_x, best_fitness, improve, search_range, task, rng, bonus1=10, bonus2=1, sr_fix=0.4, **_kwargs):
...
def mts_ls1v1(current_x, current_fitness, best_x, best_fitness, improve, search_range, task, rng, bonus1=10, bonus2=1, sr_fix=0.4, **_kwargs):
...
def mts_ls2(current_x, current_fitness, best_x, best_fitness, improve, search_range, task, rng, bonus1=10, bonus2=1, sr_fix=0.4, **_kwargs):
...
def mts_ls3(current_x, current_fitness, best_x, best_fitness, improve, search_range, task, rng, bonus1=10, bonus2=1, **_kwargs):
...
def mts_ls3v1(current_x, current_fitness, best_x, best_fitness, improve, search_range, task, rng, bonus1=10, bonus2=1, phi=3, **_kwargs):
...
class MultipleTrajectorySearch(OptimizationAlgorithm):
    ...
    def get_parameters(self):
        ...
        """
        d = OptimizationAlgorithm.get_parameters(self)
        d.update({
    ...
    def init_population(self, task):
        ...
        """
        population, fitness, d = OptimizationAlgorithm.init_population(self, task)
