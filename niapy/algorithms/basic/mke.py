...
from niapy.algorithms.algorithm import OptimizationAlgorithm, Individual, default_individual_init, default_numpy_init
...
class MonkeyKingEvolutionV1(OptimizationAlgorithm):
    ...
    def init_population(self, task):
        ...
        """
        pop, fpop, _ = OptimizationAlgorithm.init_population(self, task)
