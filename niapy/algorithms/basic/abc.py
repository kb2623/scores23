...
class ArtificialBeeColonyAlgorithm(OptimizationAlgorithm):
    ...
    def __init__(self, population_size=10, limit=100, *args, **kwargs):
        ...
        """
        super().__init__(population_size=population_size, initialization_function=default_individual_init, individual_type=SolutionABC,
                         *args, **kwargs)
        self.limit = limit
